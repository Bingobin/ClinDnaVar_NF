...
process Pindel_Merge {
    ...
    bcftools norm  --threads $task.cpus --check-ref w  --multiallelics -any -f ${params.reference} -Oz -o ${sample_id}.pindel.norm.vcf.gz  ${sample_id}.pindel.vcf.gz
...
process LoFreq_Call {
    ...
    bcftools norm  --threads $task.cpus --check-ref w  --multiallelics -any -f ${params.reference} -Oz  -o ${sample_id}.lofreq.norm.vcf.gz  ${sample_id}.lofreq.reformat.vcf.gz
...
process VarDict_Call {
    ...
    bcftools norm  --threads $task.cpus --check-ref w  --multiallelics -any -f ${params.reference} -Oz -o ${sample_id}.vardict.norm.vcf.gz  ${sample_id}.vardict.f.vcf.gz
...
process Pisces_Call {
    ...
    bcftools norm  --threads $task.cpus --check-ref w  --multiallelics -any -f ${params.reference} -Oz -o ${sample_id}.pisces.norm.vcf.gz  ${sample_id}.pass.vcf
